...
module Charts
  class DailyStatisticGeneratorTest < ActiveSupport::TestCase
    test "should create daily statistic record" do
      ...
      create(:cell_output, cell_type: "nervos_dao_deposit", generated_by: tx, ckb_transaction: tx, block: block, capacity: 10**8 * 1000, block_timestamp: (DateTime.now - 1.day).end_of_day.strftime("%Q"))
