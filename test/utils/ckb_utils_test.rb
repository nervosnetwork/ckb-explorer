...
class CkbUtilsTest < ActiveSupport::TestCase
  ...
  test "hexes to bins sql" do
    hashes = [
      "0x2ad11202821e68ec83fe5d8eeb4ec54f27a174fa5ca5e7b76ceea14011b5cf4a",
      "0x3078badb42a02aaf0085b93fd5f670df5c13a1bb5e02275052b0f8dde301959b",
    ]
    values = CkbUtils.hexes_to_bins_sql(hashes)
    assert_equal values,
                 "E'\\\\x2ad11202821e68ec83fe5d8eeb4ec54f27a174fa5ca5e7b76ceea14011b5cf4a'::bytea, E'\\\\x3078badb42a02aaf0085b93fd5f670df5c13a1bb5e02275052b0f8dde301959b'::bytea"
  end
  ...
  test "parse spore cell inner cluster data" do
    ...
    assert_equal info[:cluster_id],
                 "0x6ec74916945b561acc3c23eaf99a1ddd12eee990195a2a0b8709543f576153bd"
  end
