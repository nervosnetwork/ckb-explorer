...
class DaoEventTest < ActiveSupport::TestCase
  ...
  test "should have correct columns" do
    ...
    expected_attributes = %w(address_id block_id block_timestamp cell_index contract_id created_at event_type id status ckb_transaction_id updated_at value).sort
