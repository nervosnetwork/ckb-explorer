...
class AddressTest < ActiveSupport::TestCase
  ...
  test "#cal_unclaimed_compensation should return phase1 dao interests and unmade dao interests" do
    ...
    create(:cell_output, block: previous_output_block, capacity: 50000 * 10**8, ckb_transaction: previous_output_tx, tx_hash: previous_output_tx.tx_hash, generated_by: previous_output_tx, cell_type: "nervos_dao_deposit", cell_index: 0, occupied_capacity: 6100000000)
    create(:cell_output, block: previous_output_block, capacity: 50000 * 10**8, ckb_transaction: previous_output_tx, tx_hash: previous_output_tx.tx_hash, generated_by: previous_output_tx, cell_type: "nervos_dao_deposit", cell_index: 1, occupied_capacity: 6100000000)
