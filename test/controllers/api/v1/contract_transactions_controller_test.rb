  ...
  module V1
    class ContractTransactionsControllerTest < ActionDispatch::IntegrationTest
      test "should set right content type when call index" do
        valid_get api_v1_contract_transaction_url("dao_contract")

        assert_equal "application/vnd.api+json", response.media_type
      end

      test "should respond with 415 Unsupported Media Type when Content-Type is wrong" do
        get api_v1_contract_transaction_url("dao_contract"), headers: { "Content-Type": "text/plain" }
      ...
      test "should respond with 406 Not Acceptable when Accept is wrong" do
        get api_v1_contract_transaction_url("dao_contract"), headers: { "Content-Type": "application/vnd.api+json", "Accept": "application/json" }
