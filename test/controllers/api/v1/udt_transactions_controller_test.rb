...
module Api
  module V1
    class UdtTransactionsControllerTest < ActionDispatch::IntegrationTest
      ...
      test "should respond with 406 Not Acceptable when Accept is wrong" do
        ...
        get api_v1_udt_transaction_url(udt.type_hash),
      ...
      test "should contain right keys in the serialized object when call show" do
        ...
        assert_equal %w(
          ...
          rgb_txid is_btc_time_lock rgb_transfer_step
        ).sort,
      ...
      test "should return error object when tx_hash param is invalid" do
        ...
        valid_get api_v1_udt_transaction_url(udt.type_hash), params: { tx_hash: "aaa" }
      ...
      test "should return the corresponding transactions when address_hash are set" do
        ...
        page_size = 10
        udt = create(:udt, :with_transactions, published: true)
        address = udt.ckb_transactions.first.addresses.sample
        udt_ckb_transactions = udt.ckb_transactions.includes(:contained_udt_addresses).
