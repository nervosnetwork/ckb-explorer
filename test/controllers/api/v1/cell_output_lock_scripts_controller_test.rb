...
module Api
  module V1
    class CellOutputLockScriptsControllerTest < ActionDispatch::IntegrationTest
      ...
      test "should respond with 415 Unsupported Media Type when Content-Type is wrong" do
        ...
        get api_v1_cell_output_lock_script_url(cell_output.id), headers: { "Content-Type": "text/plain" }
      ...
      test "should respond with 406 Not Acceptable when Accept is wrong" do
        ...
        get api_v1_cell_output_lock_script_url(cell_output.id), headers: { "Content-Type": "application/vnd.api+json", Accept: "application/json" }
      ...
      test "should return error object when id is not a integer" do
        ...
        valid_get api_v1_cell_output_lock_script_url("ssdww")
      ...
      test "should return corresponding lock script with given cell output id" do
        cell_output = create_cell_output
