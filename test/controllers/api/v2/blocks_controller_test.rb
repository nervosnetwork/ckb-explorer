  ...
  module V2
    class BlocksControllerTest < ActionDispatch::IntegrationTest
      def setup
        ...
        block1 = create(:block, :with_block_hash, number: 1, timestamp: 1.days.ago.to_i * 1000)
        ...
        block2 = create(:block, :with_block_hash, number: 2, timestamp: 1.days.ago.to_i * 1000)
        ...
        block3 = create(:block, :with_block_hash, number: 3, timestamp: 1.days.ago.to_i * 1000)
        ...
        block4 = create(:block, :with_block_hash, number: 4, timestamp: 1.days.ago.to_i * 1000)
        ...
        block5 = create(:block, :with_block_hash, number: 5, timestamp: 1.days.ago.to_i * 1000)
