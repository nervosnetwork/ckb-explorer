    ...
    class BlocksControllerTest < ActionDispatch::IntegrationTest
      def setup
        ...
        create(:ckb_transaction, block: block2,
                                 witnesses: ["0x750000000c00000055000000490000001000000030000000310000009bd7e06f3ecf4be0f2fcd2188b23f1b9fcc88e5d4b65a8637b17723bbda3cce801140000007164f48d7a5bf2298166f8d81b81ea4e908e16ad1c000000302e3130332e3020286537373133386520323032322d30342d313129"])
        block3 = create(:block, :with_block_hash, number: 3, timestamp: 1.day.ago.to_i * 1000)
        create(:ckb_transaction, block: block3,
                                 witnesses: ["0x750000000c00000055000000490000001000000030000000310000009bd7e06f3ecf4be0f2fcd2188b23f1b9fcc88e5d4b65a8637b17723bbda3cce801140000007164f48d7a5bf2298166f8d81b81ea4e908e16ad1c000000302e3130332e3020286537373133386520323032322d30342d313129"])
        block4 = create(:block, :with_block_hash, number: 4, timestamp: 1.day.ago.to_i * 1000)
        cellbase = create(:ckb_transaction, block: block4,
                                            witnesses: ["0x750000000c00000055000000490000001000000030000000310000009bd7e06f3ecf4be0f2fcd2188b23f1b9fcc88e5d4b65a8637b17723bbda3cce801140000007164f48d7a5bf2298166f8d81b81ea4e908e16ad1c000000302e3130332e3020286537373133386520323032322d30342d313129"])
      ...
      test "should returns correct block by_epoch" do
        get by_epoch_api_v2_blocks_url, params: { epoch_number: 0, epoch_index: 0 }
        data = JSON.parse(response.body)["data"]
        assert_equal "1", data["attributes"]["number"]
      end
    end
  end
end
