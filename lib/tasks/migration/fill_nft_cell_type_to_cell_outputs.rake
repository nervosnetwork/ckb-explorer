namespace :migration do
	desc "Usage: RAILS_ENV=production bundle exec rake migration:fill_nft_cell_type_to_cell_outputs"
  task fill_nft_cell_type_to_cell_outputs: :environment do
	  cell_output_ids = []
	  ...
	  tx_ids = Set.new
	  puts "collect tx_ids..."
	  cell_output_ids.each do |output|
