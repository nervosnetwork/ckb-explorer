class ChangeDifficultyNonceAndSinceToDecimal < ActiveRecord::Migration[6.0]
  def change
    ...
    add_column :blocks, :difficulty, :decimal, precision: 80, scale: 0, default: 0
    ...
    add_column :uncle_blocks, :difficulty, :decimal, precision: 80, scale: 0, default: 0
    ...
    add_column :forked_blocks, :difficulty, :decimal, precision: 80, scale: 0, default: 0
