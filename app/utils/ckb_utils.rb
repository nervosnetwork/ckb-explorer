class CkbUtils
  ...
  def self.cal_cell_min_capacity(lock_script, type_script, binary_data)
  ...
  def self.dao_withdraw_tx_fee(ckb_transaction, dao_withdraw_tx_fee, tx_previous_outputs)
    ...
    tx_previous_outputs.sum(&:capacity) + interests - ckb_transaction.outputs.sum(:capacity)
  end
  ...
  # https://github.com/nervosnetwork/ckb/blob/de539f019592a6660d622b7f9a5eee97852e5894/util/types/src/utilities/difficulty.rs#L11
